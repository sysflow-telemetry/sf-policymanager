...
-	[`0.4.0`, `latest`](https://github.com/sysflow-telemetry/sf-policymanager/blob/0.4.0-rc3/Dockerfile), [`edge`](https://github.com/sysflow-telemetry/sf-policymanager/blob/master/Dockerfile), [`dev`](https://github.com/sysflow-telemetry/sf-policymanager/blob/dev/Dockerfile)
